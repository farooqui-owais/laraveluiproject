            ...
            <div class="card" style="margin-top:50px">
                <div class="card-header">{{ __('Dashboard') }}</div>
                    ...
                    <div class="card-body">
                       ...
                       <p class="card-text">{{$data['LoggeduserInfo']->name}}</p>
                    </div>
                    <div class="card-body">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">{{$data['LoggeduserInfo']->dob}}</p>
                    </div>
                    <div class="card-body">
                        <h5 class="card-title">Address</h5>
                        <p class="card-text">{{$data['LoggeduserInfo']->address}}</p>
                    </div>
                    <div class="card-body">
                        <h5 class="card-title">Email</h5>
                         <p class="card-text">{{$data['LoggeduserInfo']->email}}</p>
                    </div>
                    <div class="card-body">
                        <h5 class="card-title">Contact</h5>
                         <p class="card-text">{{$data['LoggeduserInfo']->phone_no}}</p>
                    </div>
